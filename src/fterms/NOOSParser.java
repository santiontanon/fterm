...
public class NOOSParser extends OntologyParser {
    ...
    private FeatureTerm parseFile(FTKBase m, Sort resultingSort, Ontology o) throws Exception {
        ...
        if (t.type == NOOSToken.TOKEN_LEFT_PAR) {
            ...
            if (num == 1) {
                ...
                System.err.println("NOOSParser: Error 6: several objects share the same id '" + t.token + "', their sorts are:");
                for (FeatureTerm f2 : l) {
    ...
    protected boolean setupOValuesAndFeatureValuesOfSpecificSort(Sort sort, List<FeatureTerm> hierarchy, FeatureTerm f,
        ...
        if (t.type == NOOSToken.TOKEN_LEFT_PAR) {
            ...
            t = NOOSToken.getTokenNOOS(fp);
            if (t.type != NOOSToken.TOKEN_SYMBOL) {
                System.err.println("NOOSParser: Error 8");
                error = true;
                return error;
            } // if 
            if (t.token.equals("define")) {
                System.err.println("NOOSParser: Error 8a");
                error = true;
                return error;
            } // if 
            tokenName = t.token;
            ...
            System.err.println("NOOSParser: Error 17");
            error = true;
            return error;
        ...
        do {
            ...
            if (t.type == NOOSToken.TOKEN_LEFT_PAR) {
                ...
                if (t.type == NOOSToken.TOKEN_SYMBOL && t.token.equals("define")) {
                    ...
                    if (fvalue == null) {
                        System.err.println("NOOSParser: Error 9 (token: " + t.token + "): cannot parse the value of a feature\n");
                        error = true;
                    } // if 
                    ...
                    System.err.println("NOOSParser: Error 13. Expected [SYMBOL|ROOM|PARENT] and found " + t.type + " - " + t.token);
                    error = true;
                } // if 	
                ...
                error = fvalue == null;
                if (error) {
                    System.err.println("NOOSParser: Error 18, possible incorrect feature name '" + fname.get() + "' in sort " + sort.get());
                ...
                System.err.println("NOOSParser: Error 15 (token: " + t.type + " - " + t.token + ")");
                error = true;
            } // if 
            ...
            if (!error) {
                ...
                if (fvalue == null && !delayed && !feature_variable) {
                    System.err.println("NOOSParser: Error 16");
                    error = true;
                } // if 
            }
    ...
    protected boolean setupSetOfElements(List<FeatureTerm> hierarchy, FeatureTerm f,
        ...
        if (t.type == NOOSToken.TOKEN_LEFT_PAR) {
            ...
            if (t.type == NOOSToken.TOKEN_SYMBOL && t.token.equals("define")) {
                ...
                if (fvalue == null) {
                    System.err.println("NOOSParser: Error 1: cannot parse the first element of a set!");
                    error = true;
                ...
                System.err.println("NOOSParser: Error 5");
                error = true;
            } // if 
            if (error) {
                return error;
...
//					printf("Added a variable reference to \"%s\" (to a SET)\n",token);
            ...
            System.err.println("NOOSParser: Error 7");
            error = true;
        } // if 
        if (error) {
            return true;
    ...
    private FeatureTerm setupParent(List<FeatureTerm> hierarchy, FeatureTerm f,
        ...
        if (ndots == 1) {
            ...
            if (hierarchy.isEmpty()) {
                System.err.println("NOOSParser: Error 3");
                error = true;
                return null;
            } else {
...
//					printf("\n");
        if (t.type == NOOSToken.TOKEN_RIGHT_PAR) {
            ...
            System.err.println("NOOSParser: Error 4");
            error = true;
            return null;
        }
        return fvalue;
...
//					printf("\n");
        if (t.type == NOOSToken.TOKEN_RIGHT_PAR) {
            ...
            System.err.println("NOOSParser: Error 2");
            error = true;
            return null;
        } // if 
        return fvalue;
