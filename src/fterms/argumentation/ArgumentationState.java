...
public class ArgumentationState {
    ...
    public List<Pair<Argument,ArgumentationTree>> getUnacceptable(String name, ArgumentAcceptability aa, List<ArgumentationAgent> agents) throws FeatureTermException {
...
//                System.out.println(defenders.size() + " defenders for A"+aNode.m_b.getRoot().m_ID+" generated by " + aNode.m_a);
    ...
    public List<Pair<Argument,ArgumentationTree>> getAcceptable(String name, ArgumentAcceptability aa, List<ArgumentationAgent> agents) throws FeatureTermException {
        List<Pair<Argument,ArgumentationTree>> args = new LinkedList<Pair<Argument,ArgumentationTree>>();
        for(Pair<String,ArgumentationTree> aNode:m_baseArguments) {
    ...
    public List<ArgumentationTree> getDefeatedUnsettled(String name, List<ArgumentationAgent> agents) {
        ...
        for(Pair<String,ArgumentationTree> aNode:m_baseArguments) {
            if (aNode.m_a.equals(name) && aNode.m_b.defeatedP() &&
                !aNode.m_b.settledP(aNode.m_b.getRoot(), agents)) {
                args.add(aNode.m_b);
            }
        }
        return args;
    ...
    public ArgumentationTree getTree(Rule r) {
        for(Pair<String,ArgumentationTree> aNode:m_baseArguments) {
            if (aNode.m_b.getRoot().m_rule==r) return aNode.m_b;
        }
        return null;
    }
