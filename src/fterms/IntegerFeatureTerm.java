...
public class IntegerFeatureTerm extends FeatureTerm {
	...
	IntegerFeatureTerm(Symbol name,Integer value,Ontology o) throws FeatureTermException {
		m_name = name;
		m_value = value;
	...
	FeatureTerm cloneInternal2(HashMap<FeatureTerm,FeatureTerm> correspondences, FTKBase dm,Ontology o) throws FeatureTermException {
		FeatureTerm f = new IntegerFeatureTerm(m_name,m_value,o);
	...
	public boolean equals(Object o) {
		if (o instanceof IntegerFeatureTerm) {
			if ((((IntegerFeatureTerm)o).m_value!=null && ((IntegerFeatureTerm)o).m_value.equals(m_value))) return true;
		}
