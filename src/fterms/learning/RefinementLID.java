...
/*
            {
                if (last_description!=null) {
                    if (!last_description.subsumes(current_description)) System.out.println("rLID3: SANITY CHECK 1 FAILRED!!!!!!!!!!!!!!!!");
                    if (current_description.subsumes(last_description)) System.out.println("rLID3: SANITY CHECK 2 FAILRED!!!!!!!!!!!!!!!!");
                }
